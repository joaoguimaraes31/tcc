 ...
 */
public class TelaPedidoProcessamento2 extends Janela {
	...
	public TelaPedidoProcessamento2(ControladoraInteracaoPedido controladoraInteracaoPedido, SolicitaPedido solicitaPedido) {
	...
	implements ActionListener {
		public void actionPerformed(ActionEvent e){
			String IDPedido;
			IDPedido = T1.getText();
//			metodo de processamento de pedidos
			controladoraInteracaoPedido.processar(IDPedido);
		}
...
//			 método para voltar para a tela de pesquisa de clientes
			...
			controladoraInteracaoPedido.criarTelaPedidoProcessamento();				
		}
